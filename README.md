...
- **Web Authentication** — Console login is always required once a user account exists. The first registered user becomes admin. See [Web Authentication](https://qwenpaw.agentscope.io/docs/security#Web-Authentication) for details.
